    ...
    <div className="pb-20 bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="mb-4">
        ...
        <div 
          ...
          className="flex overflow-x-auto scrollbar-hide snap-x snap-mandatory pl-5 pr-5 gap-4"
          ...
          {allFunctions.map((item) => (
            ...
            >
              <div className="flex flex-col items-center gap-2">
                ...
                {/* 文字 */}
                <span className="text-xs text-slate-600 font-medium text-center leading-tight">{item.name}</span>
              </div>
            </div>
          ))}
        </div>
